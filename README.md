...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/aws-c-s3-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-c-s3-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `aws-c-s3` available on your platform:
...
```
pixi search aws-c-s3 --channel conda-forge
```
